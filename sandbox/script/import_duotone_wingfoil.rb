...
# Duotone Wing Foiling import from Google Sheets CSV (Shopify format)
#
...
#
# Run:
#   bin/kamal app exec --reuse "bin/rails runner /rails/script/import_duotone_wingfoil.rb"
...
CURRENCY = 'EUR'
STORE_ID = 2
CSV_URL  = 'https://docs.google.com/spreadsheets/d/1kSRCBRXylN6g_V3lZLgeuKDq6Geqf21xAY2g2kdxkOg/export?format=csv'
...
rows_by_handle.each_with_index do |(handle, rows), idx|
  ...
  # Prices are direct EUR values (not ×10 like some other imports)
...
puts "\n\n#{'=' * 60}"
puts "Duotone Wing Foiling import complete in #{elapsed}s"
