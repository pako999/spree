# Override Devise's password reset email — instead of sending via SMTP,
# fire a Klaviyo event with the reset URL. Customer receives the email
# via a Klaviyo flow triggered on "Password Reset Requested" metric.
module Spree
  module UserDeviseKlaviyoDecorator
    # Devise calls this to send the reset password email.
    # We intercept it: generate the token, fire a Klaviyo event, skip SMTP.
    ...
    # Same idea for confirmation instructions
